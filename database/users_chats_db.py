...
class Database:
    ...
    async def get_set_mgrp(self , link=None):
        if link is None:
            doc_link = await self.mGrp.find_one()
            if doc_link:
