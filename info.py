...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002224002358 -1002194109031').split()]
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002378415644')
